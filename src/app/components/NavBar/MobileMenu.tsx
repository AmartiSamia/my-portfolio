        ...
        <nav className="bg-[#112240] flex justify-center items-center h-max text-[#64ffda] text-lg pt-10">
            <ul className="block justify-center items-center space-y-10 pt-1">
               ...
               <li> <a href="#skills" onClick={() => handleClick("skills")}  className="hover:text-[#64ffda]"><div className="flex justify-center">03. </div><span className="text-[#CCD6F6] hover:text-[#64ffda] flex justify-center">Skills</span></a></li>
                <li> <a href="#projects" onClick={() => handleClick("projects")}  className="hover:text-[#64ffda]"><div className="flex justify-center">04. </div><span className="text-[#CCD6F6] hover:text-[#64ffda] flex justify-center">Projects</span></a></li>
                <li>  <a href="#certifications" onClick={() => handleClick("certifications")}  className="hover:text-[#64ffda]"><div className="flex justify-center">05. </div><span className="text-[#CCD6F6] hover:text-[#64ffda] flex justify-center">Certifications</span></a></li>
