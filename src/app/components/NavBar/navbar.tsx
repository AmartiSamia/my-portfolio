  ...
  return (
    <div id="NavBar_principal" className="hidden lg:block">
      <nav className="flex items-center space-x-8 text-[#64ffda] text-sm">
        ...
        <a href="#projects" onClick={() => handleClick("projects")} className="hover:text-[#64ffda]">04. <span className="text-[#CCD6F6] hover:text-[#64ffda]">Projects</span></a>
        <a href="#certifications" onClick={() => handleClick("certifications")} className="hover:text-[#64ffda]">05. <span className="text-[#CCD6F6] hover:text-[#64ffda]">Certifications</span></a>
