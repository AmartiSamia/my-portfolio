...
export default function Projects(){
    ...
    <div className="md:w-3/3  sm:mx-8 max-sm:w-full">
      <h1 className="text-[#64ffda] text-xl font-bold mb-4 flex items-center">
        ...
        <span id="Name" className="text-[#ccd6f6] text-3xl ml-2 sm:text-2xl">Some Things I’ve Built</span>
        <hr className="flex-grow border-t border-[#8892b0bd] ml-4 mr-[70px] " />
      </h1>
   ...
   <a href="">
    ...
    <div className="relative inline-block w-[436px]">
     ...
     VisionText - AI-Driven Text-to-Image Platform
       ...
       <div id="Name" className="flex space-x-4 mt-[15px] text-gray-200 mb-4 justify-center ">
              <span >
                React
              </span>
              <span>
    ...
    >
     ...
     <div className="sm:hidden lg:block sm:w-[500px] sm:h-[530px]">
    <div
  style={{
    position: 'relative',
...
>
  ...
  />
    ...
    <div className="lg:block sm:hidden md:w-2/2 md:pl-8 z-10 lg:mr-[-95px] transition-all sm:mt-[-180px]  lg:mt-[30px] duration-200">
