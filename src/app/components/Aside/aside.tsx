            ...
            <aside className="fixed bottom-0 left-10 flex flex-col items-center space-y-10 lg:block sm:hidden">
                <ul className="space-y-6 ">
                    ...
                    <li>
                        <a href="https://github.com/bchiang7" aria-label="GitHub" target="_blank" rel="noreferrer">
                            <svg
                                ...
                                className="feather feather-github w-6 h-6 text-gray-400 hover:text-[#64ffda] transform hover:scale-110 transition-all duration-300"
                            >
                                <title>GitHub</title>
                    ...
                    <li>
                        <a href="https://www.instagram.com/bchiang7" aria-label="Instagram" target="_blank" rel="noreferrer">
                            <svg
                                ...
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                className="feather feather-instagram w-6 h-6 text-gray-400 hover:text-[#64ffda] transform hover:scale-110 transition-all duration-300"
                            >
                    ...
                    <a href="mailto:brittany.chiang@gmail.com" aria-label="Gmail">
                            ...
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24"
                            className="w-6 h-6 text-gray-400 hover:text-[#64ffda] transition-transform duration-300 hover:scale-110"
                        >
                            <title>Gmail</title>
                    ...
                    <li>
                        <a href="https://www.linkedin.com/in/bchiang7" aria-label="LinkedIn" target="_blank" rel="noreferrer">
                            <svg
                                ...
                                strokeLinecap="round"
                                strokeLinejoin="round"
                                className="feather feather-linkedin w-6 h-6 text-gray-400 hover:text-[#64ffda] transform hover:scale-110 transition-all duration-300 "
                            >
                ...
                <div className="w-px h-31 bg-gray-400"></div>
            </aside>
            <aside className="fixed bottom-0 right-0 mr-[-20px] flex flex-col items-center space-y-29">
                <a href="mailto:brittany.chiang@gmail.com" className="text-gray-400 hover:text-[#64ffda] transform rotate-90 transition-all duration-300 lg:block sm:hidden">
